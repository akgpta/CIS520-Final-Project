...
\newcommand{\PrintFirstHeader}{
  ...
  \begin{table}[ht]
\begin{tabular}{l|l}
\Large{Team Member} & \Large{Contributions} \\ \hline
  \normalsize{Monal}         &    \normalsize{Past Work, Solution Approach, Machine Learning Algorithms, Visualizations, Report}           \\
   \normalsize{Amit}         &        \normalsize{Problem Formulation, Algorithms Plan for Use, Machine Learning Algorithms, Visualizations, Report}       \\
            \normalsize{Aashish}&       \normalsize{Data Cleaning, Data Stitching, Machine Learning Algorithms, Visualizations, Report}        \\
         \normalsize{Moksh}   &            \normalsize{Data Cleaning, Data Stitching, Machine Learning Algorithms, Visualizations, Report}  
\end{tabular}
\end{table}
...
\section{Problem Formulation and Data Set} 
...
\TODO : A LOT OF GOOD STUFF IN MESSENGER \TODO
