...
>>>>>>> 2dbd03c6eec0eed17e4436b09d3401cbec9e6aae
...
<<<<<<< HEAD
    ...
    \end{spacing}
=======
    \begin{spacing}{1.2}\label{fig:a}
    \captionof{figure}{Cross Validation Error for k-Nearest Neighbors Using Minkowski Distance. \\{\small Note that $q=2$ refers to a model built off of a Euclidean distance formula.}} 
	\end{spacing}
>>>>>>> 2dbd03c6eec0eed17e4436b09d3401cbec9e6aae
\endgroup
