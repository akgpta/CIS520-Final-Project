...
\subsection{Linear Regression} First, we implemented a linear regression as our base line model. As most related papers ran linear regression, we also ran regularized and unregularized least squares linear regression to use as a baseline. Additional detail is omitted here for the sake of parsimony. 
...
% \includegraphics[scale = .25]{geo-bee.jpg}
